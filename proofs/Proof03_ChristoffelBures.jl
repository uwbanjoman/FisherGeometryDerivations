...
PROOF
  ...
  Differentiating g_{ab}(ρ) = (1/4) Re Tr(Tₐ L_b(ρ)):
      ...
      ∂_c g_{ab}|₀ = (1/4)(−n²/2) Re Tr(Tₐ {T_c, T_b})
                   = −(n²/8) · Re Tr(Tₐ T_c T_b + Tₐ T_b T_c)
                   = −(n²/8) · (d_{acb}/4 + d_{abc}/4)
                   = −(n²/8) · (d_{abc}/2)         [d totally symmetric]
                   = −(n²/16) · d_{abc}             □
...
function theorem_A(; n=6, verbose=true)
    verbose && println("""
    ─────────────────────────────────────────────────────────────
    THEOREM A  ∂_c g_{ab}|_{ρ*} = −(n²/16) d_{abc}
    ─────────────────────────────────────────────────────────────
    """)
...
function proof()
    ...
    if all(results)
        ...
        println("  A  ∂_c g_{ab}|_{ρ*} = −(n²/16) d_{abc}")
